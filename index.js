...
function calcular(n1,n2, chamaFuncao) {
  return chamaFuncao(n1, n2)
...
console.log(`A soma de 3 com 4 é ${resultadoSoma}`);
...
console.log(`Colocamo em ordem os numero 11 e 7: ${ordenaPragente}`);
...
console.log(`O obejto ${nome} é feito de ${tipo} e pesa ${peso}kg.`);
...
const nascimento = new Date(1986, 11, 04)
...
const pessoa2 = {
  ...
  apresentacao: () => {
    ...
    return `Olá, eu sou ${pessoa2.nome} ${pessoa2.sobrenome}, tenho ${pessoa2.idade} ${anos}, ${pessoa2.altura}, 
    meu peso é ${pessoa2.peso} e, só hoje, eu já caminhei ${pessoa2.caminhouQuantosMetros} ${metros}!`
  }
}
